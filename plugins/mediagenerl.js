...
ezra({ nomCom: "igdl", categorie: "viper-Download" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "tiktok", categorie: "viper-Download", reaction: "🎵" }, async (dest, zk, commandeOptions) => {
