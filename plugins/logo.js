...
ezra({
  ...
  try {
    ...
    repondre("* processing...*");
    await zk.sendMessage(origineMessage, { image: { url: anu.image }, caption: "* \t Logo made by viper xmd*" }, { quoted: ms });
  }
  catch (e) {
    repondre("🥵🥵 " + e);
  }
});
ezra({ nomCom: "dragonball", categorie: "viper-Logo", reaction: "🐉" }, async (dest, zk, commandeOptions) => {
  ...
  try {
    ...
    await zk.sendMessage(dest, { image: { url: imgInfo.image }, caption: "* \t Logo by viper xmd*" }, { quoted: ms });
  }
  catch (e) {
    repondre("🥵🥵 " + e);
  }
...
////////////////////////////
ezra({ nomCom: "naruto", categorie: "viper-Logo", reaction: "👀" }, async (dest, zk, commandeOptions) => {
  ...
  try {
    ...
    await zk.sendMessage(dest, { image: { url: img.image }, caption: "\t\t *Logo by viper xmd*" }, { quoted: ms });
  }
  catch (e) {
    repondre("🥵🥵 " + e);
  }
...
ezra({ nomCom: "wall", categorie: "viper-Logo", reaction: "👍" }, async (dest, zk, commandeOptions) => {
  ...
  mumaker.textpro("https://textpro.me/break-wall-text-effect-871.html", text)
    .then((data) => {
      zk.sendMessage(dest, { image: { url: data.image }, caption: 'Logo by viper xmd' }, { quoted: ms })
    })
    .catch(console.log)
})
  ;
ezra({ nomCom: "summer", categorie: "viper-Logo", reaction: "🌞" }, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "neonlight", categorie: "viper-Logo", reaction: "💡" }, async (dest, zk, commandeOptions) => {
  ...
  try {
    ...
    /*.then((data) => {*/
    zk.sendMessage(dest, { image: { url: maker.image }, caption: 'Logo by viper xmd' }, { quoted: ms });
...
ezra({ nomCom: "greenneon", categorie: "viper-Logo", reaction: "🟢" }, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "glitch", categorie: "viper-Logo", reaction: "🎛️" }, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "devil", categorie: "viper-Logo", reaction: "😈" }, async (dest, zk, commandeOptions) => {
  const { arg, repondre, ms, prefixe } = commandeOptions;
  if (!arg[0]) {
...
ezra(
  {
    ...
    try {
      ...
      repondre("  processing ...")
      await zk.sendMessage(dest, { image: { url: img.image }, caption: "\t *Logo by viper xmd*" })
...
//water
ezra({ nomCom: "water", categorie: "viper-Logo", reation: "💦" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "snow", categorie: "viper-Logo", reaction: "❄️" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "transformer", categorie: "viper-Logo", reaction: "🤖" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe, repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "thunder", categorie: "viper-Logo", reaction: "⚡" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe, repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "harrypotter", categorie: "viper-Logo", reaction: "🧙‍♂️" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe, repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "cat", categorie: "viper-Logo", reaction: "🪟" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "whitegold", categorie: "viper-Logo", reaction: "💫" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe, repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "lightglow", categorie: "viper-Logo", reaction: "🌟" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe, repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "thor", categorie: "viper-Logo", reaction: "🔨" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe, repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "neon", categorie: "viper-Logo", reaction: "💡" }, async (dest, zk, commandeOptions) => {
  const { arg, ms, prefixe, repondre } = commandeOptions;
  if (!arg[0]) {
...
ezra({ nomCom: "gold", categorie: "viper-Logo", reaction: "🧚🏿‍♀️" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "arena", categorie: "viper-Logo", reaction: "🥵" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "incandescent", categorie: "viper-Logo", reaction: "😋" }, async (dest, zk, commandeOptions) => {
...
ezra({ nomCom: "gif×1", categorie: "viper-Logo", reaction: "😋" }, async (dest, zk, commandeOptions) => {
  let { ms, arg, prefixe, repondre } = commandeOptions;
  try {
    if (!arg || arg === "") {
      repondre(`${prefixe}gif×1 Lucky-MD`);
      return;
    }
    ...
    repondre("Processing...");
    await zk.sendMessage(dest, { image: { url: img }, caption: "*Logo by LUCKY MD XFORCE*" }, { quoted: ms });
  } catch (e) {
    repondre(e);
  }
});
